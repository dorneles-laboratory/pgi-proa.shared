...
export const rfc7807ErrorSchema = registry.register('ProblemDetails', z.object({
...
export const paginationMetaSchema = registry.register('PaginationMeta', z.object({
...
export const paginationSchema = registry.register('PaginationQuery', z.object({
    page: z.coerce
...
export function createPaginatedResponseSchema(schema, schemaName) {
    return registry.register(schemaName, z.object({
        data: z.array(schema),

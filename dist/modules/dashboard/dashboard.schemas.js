...
export const dashboardResponseSchema = registry.register('DashboardResponse', z.object({
    kpis: z.object({
        totalTasks: z.number(),
        totalHours: z.number(),
    ...
    hoursPerNature: z.array(z.object({
        natureza: z.string(), // Ex: 'DEV', 'MEETING'
        horas: z.number(),
    })),
    appointmentsPerProject: z.array(z.object({
        projeto: z.string(),
        horas: z.number(),
    })),

...
// 1. O que o Frontend ENVIA para CRIAR a tarefa
export const createTaskSchema = registry.register('CreateTaskRequest', z.object({
    title: z
        .string()
        .min(2)
        .max(120)
...
// 2. O que o Frontend ENVIA para ATUALIZAR a tarefa
...
export const taskIdSchema = z.object({
    id: z.string().uuid({ message: 'O ID da tarefa deve ser um UUID válido.' }).openapi({
